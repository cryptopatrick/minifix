...
//!
//! ```toml
//! minifix = { version = "0.1", features = ["codegen"] }
//! ```
//!
...
//!   **A.** Use [`minifix::tagvalue::Decoder`](crate::tagvalue::Decoder) and
//!   [`minifix::tagvalue::DecoderStreaming`](crate::tagvalue::DecoderStreaming).
